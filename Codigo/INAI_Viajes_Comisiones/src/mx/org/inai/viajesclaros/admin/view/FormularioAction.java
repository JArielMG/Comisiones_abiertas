	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
		...
		if (action.equals("listarComisiones")) {
			...
			if (datosFuncionario!=null&&!datosFuncionario.isEmpty()){
					...
					if (comisionEnCurso.getEstatus().equals("C")||comisionEnCurso.getEstatus().equals("EA")||comisionEnCurso.getEstatus().equals("R")){
						...
						*/
						// Se setean los atributos para el formulario cuando el estatus es "EA"
							...
							request.setAttribute("nombreFormulario", "Solicitud de vi�ticos y pasajes");
							request.setAttribute("error", true);
							request.setAttribute("mensajeError", "Su comisi�n se encuentra con el estatus: \""+estatusTexto+". Debe esperar a la aprobaci�n de la misma a fin de continuar con la solicitud de vi�ticos y pasajes.");
						}
						...
						*/
						...
						// Se setean los atributos para el formulario cuando el estatus es "EA"
							...
							request.setAttribute("nombreFormulario", "Desglose de gastos");
							request.setAttribute("error", true);
							request.setAttribute("mensajeError", "Su comisi�n se encuentra con el estatus: \""+estatusTexto+". Debe esperar a la aprobaci�n de la misma a fin de continuar con el desglose de gastos.");
						}
						...
						// Se setean los atributos para el formulario cuando el estatus es "A"
							...
							request.setAttribute("error", false);
							request.setAttribute("autorizada", true);
							request.setAttribute("mensajeAutorizada", estatusTexto+". Ha finalizado el proceso de publicaci�n de la comisi�n.");
						...
						// Se setean los atributos para el formulario cuando el estatus es "EA"
							...
							request.setAttribute("nombreFormulario", "Informe de comisi�n");
							request.setAttribute("error", true);
							request.setAttribute("mensajeError", "Su comisi�n se encuentra con el estatus: \""+estatusTexto+". Debe esperar a la aprobaci�n de la misma a fin de continuar con el proceso de publicaci�n.");
						}
				...
				//Caso que aplica para cuando el funcionario no tiene comisiones en curso
					...
					request.setAttribute("nombreFormulario", "Solicitud de comisi�n");
					request.setAttribute("seccionesFormulario", seccionesFormulario);
					request.setAttribute("nombreDepedencia", funcionario.getNombreDependencia());
					request.setAttribute("estatus", "C");
				}/*else{
			...
			// Se setean los atributos para generar un mensaje de error al no haber encontrado informaci�n del funcionario
				...
				request.setAttribute("nombreFormulario", "Solicitud de comisi�n");
				request.setAttribute("error", true);
				request.setAttribute("mensajeError", "No se encontro informaci�n del funcionario para realizar la Solicitud de Comisi�n");
			}
		...
		//Se ejecuta al cargar el formulario de solicitud  de comisi�n
			...
			if (estatus.equals("C")||estatus.equals("R"))
				...
				request.setAttribute("nombreFormulario", "Solicitud de publicaci�n");
			...
			request.setAttribute("mensajeGuardado", "Se han guardado los datos �xitosamente. Puede proceder a enviar su solicitud o regresar al formulario para realizar cambios antes de su env�o. ");
			...
			request.setAttribute("mensajeEnviada", "Se ha enviado su solicitud para su aprobaci�n.");
