...
public class PersonAction extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action.equals("listarTipos")) {
            ...
            ArrayList<TipoIntegranteVista> tipos_integrante = personServ.obtenerTiposIntegrantes();
            ...
            request.setAttribute("tipos_integrantes", tipos_integrante);
            ...
            String snumeroEmpleado = request.getParameter("numeroEmpleado");
            String puesto = request.getParameter("puesto");
            String clavePuesto = request.getParameter("clavePuesto");
            String sexo = request.getParameter("sexo");
            String tipoRepresentacion = request.getParameter("tipoRepresentacion");
            String fechaIngreso = request.getParameter("fechaIngreso");
            String tipoIntegrante = request.getParameter("tipo_integrante");

            if (sid == null || nombres == null || apPaterno == null || correo == null
                    || sCat == null || sTipo == null || cargo == null
                    || snumeroEmpleado == null || puesto == null || clavePuesto == null
                    || sexo == null || tipoRepresentacion == null || fechaIngreso == null) {
                ...
                Integer numeroEmpleado = Integer.parseInt(snumeroEmpleado);
                DateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
                Integer idTipoIntegrante = Integer.parseInt(tipoIntegrante);
                ...
                persona.setNumeroEmpleado(numeroEmpleado);
                persona.setDenominacionPuesto(puesto);
                persona.setClavePuesto(clavePuesto);
                persona.setSexo(sexo);
                persona.setTipoRepresentacion(tipoRepresentacion);
                persona.setTipoIntegrante(idTipoIntegrante);
                try {
