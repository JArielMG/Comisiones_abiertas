 ...
 */
@Embeddable
public class CamposBasePK implements Serializable {
    ...
    public CamposBasePK(String tabla, String campo) {
        this.tabla = tabla;
        this.campo = campo;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CamposBasePK)) {
            return false;
        }
        CamposBasePK other = (CamposBasePK) object;
    ...
    public String toString() {
        return "mx.org.inai.viajesclaros.entities.CamposBasePK[ tabla=" + tabla + ", campo=" + campo + " ]";
    }
